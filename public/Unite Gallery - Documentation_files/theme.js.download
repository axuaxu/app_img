...
(function() {
	...
	var Core = {
		...
		navMenu: function() {
			...
			$(".nav-main li.dropdown > a, .nav-main li.dropdown-submenu > a").on("click", function(e) {
				...
				$(".nav-main").find(".resp-active").removeClass("resp-active");
			...
			$(".nav-main li.dropdown-submenu").hover(function() {
